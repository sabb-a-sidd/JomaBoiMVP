          ...
          children: [
            ListTile(
              ...
              subtitle: BlocBuilder<AppCubit, AppState>(builder: (context, state) {
                return Text(state.username ?? 'Not set',style: Theme.of(context).textTheme.bodySmall?.apply(color: Colors.grey, overflow: TextOverflow.ellipsis));
              }),
            ),
            ListTile(
              dense: true,
              ...
              subtitle: BlocBuilder<AppCubit, AppState>(builder: (context, state) {
                if (state.currency == null) {
                  return Text('Not set', style: Theme.of(context).textTheme.bodySmall?.apply(color: Colors.grey, overflow: TextOverflow.ellipsis));
                }
                Currency? currency = CurrencyService().findByCode(state.currency!);
                return Text(currency?.name ?? 'Unknown currency', style: Theme.of(context).textTheme.bodySmall?.apply(color: Colors.grey, overflow: TextOverflow.ellipsis));
              }),
            ),
            ListTile(
              dense: true,
